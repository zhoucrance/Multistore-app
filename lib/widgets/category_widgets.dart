...
class SubcategModel extends StatelessWidget {
  ...
  const SubcategModel({Key? key, required this.subcategLabel,required this.assetName,required this.mainCategName,required this.subCategName}) : super(key: key);
    ...
    return GestureDetector(
      ...
      child: Column(
        children: [
          ...
          Text(subcategLabel, style: const TextStyle(fontSize: 12),)
        ],
      ),
    );
  }
...
class CategHeaderLabel extends StatelessWidget {
  ...
  const CategHeaderLabel({Key? key, required this.headerLabel}) : super(key: key);
